      ...
      <Switch>
        {!isAuthenticated ? (
          ...
          <>
            ...
            <Route path="/algorithm-training" component={AlgorithmTraining} />
            ...
            <Route path="/performance-attribution" component={PerformanceAttribution} />
            <Route path="/monitoring" component={ProductionMonitoring} />
