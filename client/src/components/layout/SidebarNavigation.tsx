...
import { BarChart3, TrendingUp, Wallet, Settings, Activity, Zap, Brain, MessageCircle, Target, Timer, Play, PieChart, Shield, Users, Monitor } from 'lucide-react';
    ...
    <aside className="hidden lg:flex w-64 bg-gray-800 border-r border-gray-700 flex-col" data-testid="side-rail">
      ...
      <div className="p-4 border-t border-gray-700">
        <div className="space-y-2">
          ...
          <button 
            onClick={() => setLocation('/social-trading')}
            className={`w-full flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors ${
              location === '/social-trading' 
                ? 'bg-pink-600/20 text-pink-400' 
                : 'text-gray-400 hover:bg-gray-700 hover:text-white'
            }`}
            data-testid="link-social-trading"
          >
